...
class PDO_Connecion{
     ...
     * @param string $config_file   Path to connection config file.
     * @param bool $debug
     */
    public function __construct($db_name, $config_file, $debug=false){
    ...
    /**
     * If debug mode is activated from the constructor, then output SQL statement text.
     * @param string $stmt             SQL statement
     * @param array $whereArray
     */
